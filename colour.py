...
img_path = r'D:/new projects/black and white/image.jpg'
#--------------#--------------#

# Check if files exist
for file in [proto_file, model_file, hull_pts, img_path]:
...
net.setInput(cv2.dnn.blobFromImage(L))  # Corrected line
